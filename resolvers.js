...
module.exports = {
    Query: {
        ...
        infiniteScrollPosts: async (_, { pageNum, pageSize }, { Post }) => {
            ...
            if (pageNum === 1) {
                ...
                // If page number greater then one, figure out how many documents to skip
    ...
    Mutation: {
        ...
        addPostMessage: async (_, { messageBody, userId, postId }, { Post }) => {
            ...
            const post = await Post.findOneAndUpdate(
                { _id: postId },
                // prepand (push) new message to beginning of messages array
        ...
        unlikePost: async (_, { postId, username }, { Post, User }) => {
            ...
            //Find User, remove id of post to from favorites array(which will be populated as Posts)
            const user = await User.findOneAndUpdate(
                { username },
